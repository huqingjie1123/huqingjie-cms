...
$(function(){
 ...
 function goPage(page){
	 //location.href="/user/selects?page="+page
			 ...
			 var orderName = '${vo.orderName}';
		var  url="/admin/article/complains?pageNum="+page+$("#form1").serialize()+"&orderName="+orderName+"&orderMethod="+orderMethod;
		$("#center").load(url);	 //
