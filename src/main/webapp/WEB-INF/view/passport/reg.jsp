		...
		<div class="col-md-4">
			<form id="form" action="/passport/reg" method="post" >
				...
				<div class="form-group">
					...
					<input id="repassword" class="form-control" type="password" name="repassword" value="${user.repassword }" >
				</div>
				
				<div class="form-group form-inline">
					<label>性别</label>&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="radio" name="gender" class="form-control" value="0" checked="checked" >男
					&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="radio" name="gender" class="form-control" value="1" >女
				</div>
